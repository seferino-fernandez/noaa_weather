...
impl WmoUnitCode {
    ...
    pub fn unit_code(&self) -> &'static str {
        match self {
            WmoUnitCode::MinuteAngle => "wmoUnit:\'",
            WmoUnitCode::SecondAngle => "wmoUnit:\"",
            WmoUnitCode::PartsPerThousand => "wmoUnit:0.001",
            WmoUnitCode::Dimensionless => "wmoUnit:1",
            WmoUnitCode::Ampere => "wmoUnit:A",
            WmoUnitCode::AstronomicUnit => "wmoUnit:AU",
            WmoUnitCode::Becquerel => "wmoUnit:Bq",
            WmoUnitCode::BecquerelsPerLitre => "wmoUnit:Bq_l-1",
            WmoUnitCode::BecquerelsPerSquareMetre => "wmoUnit:Bq_m-2",
            WmoUnitCode::BecquerelsPerCubicMetre => "wmoUnit:Bq_m-3",
            WmoUnitCode::BecquerelSecondsPerCubicMetre => "wmoUnit:Bq_s_m-3",
            WmoUnitCode::Coulomb => "wmoUnit:C",
            WmoUnitCode::DegreesCelsiusPer100Metres => "wmoUnit:C_-1",
            WmoUnitCode::DegreesCelsiusPerMetre => "wmoUnit:C_m-1",
            WmoUnitCode::DegreeCelsius => "wmoUnit:Cel",
            WmoUnitCode::DobsonUnit9 => "wmoUnit:DU",
            WmoUnitCode::Farad => "wmoUnit:F",
            WmoUnitCode::Gray => "wmoUnit:Gy",
            WmoUnitCode::Henry => "wmoUnit:H",
            WmoUnitCode::Hertz => "wmoUnit:Hz",
            WmoUnitCode::Joule => "wmoUnit:J",
            WmoUnitCode::JoulesPerKilogram => "wmoUnit:J_kg-1",
            WmoUnitCode::JoulesPerSquareMetre => "wmoUnit:J_m-2",
            WmoUnitCode::Kelvin => "wmoUnit:K",
            WmoUnitCode::KelvinsPerMetre => "wmoUnit:K_m-1",
            WmoUnitCode::KelvinSquareMetresPerKilogramPerSecond => "wmoUnit:K_m2_kg-1_s-1",
            WmoUnitCode::KelvinMetresPerSecond => "wmoUnit:K_m_s-1",
            WmoUnitCode::Newton => "wmoUnit:N",
            WmoUnitCode::NewtonsPerSquareMetre => "wmoUnit:N_m-2",
            WmoUnitCode::NUnits => "wmoUnit:N_units",
            WmoUnitCode::Ohm => "wmoUnit:Ohm",
            WmoUnitCode::Pascal => "wmoUnit:Pa",
            WmoUnitCode::PascalsPerSecond => "wmoUnit:Pa_s-1",
            WmoUnitCode::Siemens => "wmoUnit:S",
            WmoUnitCode::SiemensPerMetre => "wmoUnit:S_m-1",
            WmoUnitCode::Sievert => "wmoUnit:Sv",
            WmoUnitCode::Tesla => "wmoUnit:T",
            WmoUnitCode::Volt => "wmoUnit:V",
            WmoUnitCode::Watt => "wmoUnit:W",
            WmoUnitCode::Kilowatt => "wmoUnit:kW",
            WmoUnitCode::WattsPerMetrePerSteradian => "wmoUnit:W_m-1_sr-1",
            WmoUnitCode::WattsPerSquareMetre => "wmoUnit:W_m-2",
            WmoUnitCode::WattsPerSquareMetrePerSteradian => "wmoUnit:W_m-2_sr-1",
            WmoUnitCode::WattsPerSquareMetrePerSteradianCentimetre => "wmoUnit:W_m-2_sr-1_cm",
            WmoUnitCode::WattsPerSquareMetrePerSteradianMetre => "wmoUnit:W_m-2_sr-1_m",
            WmoUnitCode::WattsPerCubicMetrePerSteradian => "wmoUnit:W_m-3_sr-1",
            WmoUnitCode::Weber => "wmoUnit:Wb",
            WmoUnitCode::Year => "wmoUnit:a",
            WmoUnitCode::CentibarsPer12Hours => "wmoUnit:cb_-1",
            WmoUnitCode::CentibarsPerSecond => "wmoUnit:cb_s-1",
            WmoUnitCode::Candela => "wmoUnit:cd",
            WmoUnitCode::Centimetre => "wmoUnit:cm",
            WmoUnitCode::CentimetresPerHour => "wmoUnit:cm_h-1",
            WmoUnitCode::CentimetresPerSecond => "wmoUnit:cm_s-1",
            WmoUnitCode::Day => "wmoUnit:d",
            WmoUnitCode::Decibel6 => "wmoUnit:dB",
            WmoUnitCode::DecibelsPerDegree => "wmoUnit:dB_deg-1",
            WmoUnitCode::DecibelsPerMetre => "wmoUnit:dB_m-1",
            WmoUnitCode::DecipascalsPerSecondMicrobarPerSecond => "wmoUnit:dPa_s-1",
            WmoUnitCode::Dekapascal => "wmoUnit:daPa",
            WmoUnitCode::SquareDegrees => "wmoUnit:deg2",
            WmoUnitCode::DegreesCelsius8 => "wmoUnit:degC",
            WmoUnitCode::DegreesPerSecond => "wmoUnit:deg_s-1",
            WmoUnitCode::DegreeAngle => "wmoUnit:degree_(angle)",
            WmoUnitCode::DegreesTrue => "wmoUnit:degrees_true",
            WmoUnitCode::Decimetre => "wmoUnit:dm",
            WmoUnitCode::ElectronVolt => "wmoUnit:eV",
            WmoUnitCode::Foot => "wmoUnit:ft",
            WmoUnitCode::AccelerationDueToGravity => "wmoUnit:g",
            WmoUnitCode::GramsPerKilogram => "wmoUnit:g_kg-1",
            WmoUnitCode::GramsPerKilogramPerSecond => "wmoUnit:g_kg-1_s-1",
            WmoUnitCode::GeopotentialMetre => "wmoUnit:gpm",
            WmoUnitCode::Hour => "wmoUnit:h",
            WmoUnitCode::Hectopascal => "wmoUnit:hPa",
            WmoUnitCode::HectopascalsPer3Hours => "wmoUnit:hPa_-1",
            WmoUnitCode::HectopascalsPerHour => "wmoUnit:hPa_h-1",
            WmoUnitCode::HectopascalsPerSecond => "wmoUnit:hPa_s-1",
            WmoUnitCode::Hectare => "wmoUnit:ha",
            WmoUnitCode::Kilopascal => "wmoUnit:kPa",
            WmoUnitCode::Kilogram => "wmoUnit:kg",
            WmoUnitCode::PerSquareKilogramPerSecond => "wmoUnit:kg-2_s-1",
            WmoUnitCode::KilogramsPerKilogram => "wmoUnit:kg_kg-1",
            WmoUnitCode::KilogramsPerKilogramPerSecond => "wmoUnit:kg_kg-1_s-1",
            WmoUnitCode::KilogramsPerMetre => "wmoUnit:kg_m-1",
            WmoUnitCode::KilogramsPerSquareMetre => "wmoUnit:kg_m-2",
            WmoUnitCode::KilogramsPerSquareMetrePerSecond => "wmoUnit:kg_m-2_s-1",
            WmoUnitCode::KilogramsPerCubicMetre => "wmoUnit:kg_m-3",
            WmoUnitCode::Kilometre => "wmoUnit:km",
            WmoUnitCode::KilometresPerDay => "wmoUnit:km_d-1",
            WmoUnitCode::KilometresPerHour => "wmoUnit:km_h-1",
            WmoUnitCode::Knot => "wmoUnit:kt",
            WmoUnitCode::KnotsPer1000Metres => "wmoUnit:kt_km-1",
            WmoUnitCode::Litre => "wmoUnit:l",
            WmoUnitCode::Lumen => "wmoUnit:lm",
            WmoUnitCode::LogarithmPerMetre => "wmoUnit:log_(m-1)",
            WmoUnitCode::LogarithmPerSquareMetre => "wmoUnit:log_(m-2)",
            WmoUnitCode::Lux => "wmoUnit:lx",
            WmoUnitCode::Metre => "wmoUnit:m",
            WmoUnitCode::PerMetre => "wmoUnit:m-1",
            WmoUnitCode::SquareMetres => "wmoUnit:m2",
            WmoUnitCode::MetresToTheTwoThirdsPowerPerSecond => "wmoUnit:m2_-1",
            WmoUnitCode::SquareMetresPerHertz => "wmoUnit:m2_Hz-1",
            WmoUnitCode::SquareMetresPerRadianSquared => "wmoUnit:m2_rad-1_s",
            WmoUnitCode::SquareMetresSecond => "wmoUnit:m2_s",
            WmoUnitCode::SquareMetresPerSecond => "wmoUnit:m2_s-1",
            WmoUnitCode::SquareMetresPerSecondSquared => "wmoUnit:m2_s-2",
            WmoUnitCode::CubicMetres => "wmoUnit:m3",
            WmoUnitCode::CubicMetresPerCubicMetre => "wmoUnit:m3_m-3",
            WmoUnitCode::CubicMetresPerSecond => "wmoUnit:m3_s-1",
            WmoUnitCode::MetresToTheFourthPower => "wmoUnit:m4",
            WmoUnitCode::Millisievert => "wmoUnit:mSv",
            WmoUnitCode::MetresPerSecond => "wmoUnit:m_s-1",
            WmoUnitCode::MetresPerSecondPer1000Metres => "wmoUnit:m_s-1_km-1",
            WmoUnitCode::MetresPerSecondPerMetre => "wmoUnit:m_s-1_m-1",
            WmoUnitCode::MetresPerSecondSquared => "wmoUnit:m_s-2",
            WmoUnitCode::MinuteTime => "wmoUnit:min",
            WmoUnitCode::Millimetre => "wmoUnit:mm",
            WmoUnitCode::MillimetresPerTheSixthPowerPerCubicMetre => "wmoUnit:mm6_m-3",
            WmoUnitCode::MillimetresPerHour => "wmoUnit:mm_h-1",
            WmoUnitCode::MillimetresPerSeconds => "wmoUnit:mm_s-1",
            WmoUnitCode::Mole => "wmoUnit:mol",
            WmoUnitCode::MolesPerMole => "wmoUnit:mol_mol-1",
            WmoUnitCode::Month => "wmoUnit:mon",
            WmoUnitCode::NauticalMile => "wmoUnit:nautical_mile",
            WmoUnitCode::NanobarHpa106 => "wmoUnit:nbar",
            WmoUnitCode::EighthsOfCloud => "wmoUnit:okta",
            WmoUnitCode::PhUnit => "wmoUnit:pH_unit",
            WmoUnitCode::Parsec => "wmoUnit:pc",
            WmoUnitCode::PerCent => "wmoUnit:percent",
            WmoUnitCode::Radian => "wmoUnit:rad",
            WmoUnitCode::RadiansPerMetre => "wmoUnit:rad_m-1",
            WmoUnitCode::Second => "wmoUnit:s",
            WmoUnitCode::PerSecondSameAsHertz => "wmoUnit:s-1",
            WmoUnitCode::PerSecondSquared => "wmoUnit:s-2",
            WmoUnitCode::SecondsPerMetre => "wmoUnit:s_m-1",
            WmoUnitCode::Steradian => "wmoUnit:sr",
            WmoUnitCode::Tonne => "wmoUnit:t",
            WmoUnitCode::AtomicMassUnit => "wmoUnit:u",
            WmoUnitCode::Week => "wmoUnit:week",
        }
    }
}
