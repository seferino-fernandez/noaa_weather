...
pub struct Gridpoint12hForecastGeoJson {
    ...
    pub properties: Box<models::Gridpoint12hForecast>,
}

impl Gridpoint12hForecastGeoJson {
    pub fn new(
        r#type: Type,
        geometry: Option<models::GeoJsonGeometry>,
        properties: models::Gridpoint12hForecast,
